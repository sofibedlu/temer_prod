...
class WingDashboard extends Component {
    setup() {
...
WingDashboard.components = {DateTimePicker ,DateTimePickerPopover,DateTimeInput}
WingDashboard.template = "team_dashboard.wing_dashboard_jjokacha";
registry.category("actions").add("wing_dashboard_jjokacha", WingDashboard);