...
class TeamTajDashboard extends Component {
    setup() {
            ...
            this.state.chart = new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Team Taj - Lead Status Distribution'
                        },
                    },
                    scales: {
                        y: {
            ...
            this.state.pieChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Team Taj - Lead Status Distribution (Pie)'
                        },
                        legend: {
                            position: 'right'
                        }
    ...
    setSupervisorFilterFromLink(supervisorId) {
        ...
        const dashboardEl = document.querySelector('.o_team_taj_dashboard');
        if (dashboardEl) {
...
TeamTajDashboard.template = "team_dashboard.TeamTajDashboardTemplate";
registry.category("actions").add("TeamTajDashboardTemplate", TeamTajDashboard);