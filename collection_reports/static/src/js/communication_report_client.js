...
export class CommunicationReportClient extends Component {
    setup() {
    ...
    async loadData() {
        ...
        try {
            // Placeholder - create controller endpoint later
    ...
    async exportExcel() {
        ...
        try {
            ...
            reportTypeInput.value = 'communication';
...
CommunicationReportClient.template = "collection_reports.CommunicationReportClient";
registry.category("actions").add("collection_reports.communication", CommunicationReportClient);
