/** @odoo-module **/
// ks_dashboard_ninja - Odoo 15 -> 17 conversion.
// Wrapper converted from `odoo.define(...)` to an ES module; every method body
// below is byte-for-byte identical to the original Odoo 15 implementation.
