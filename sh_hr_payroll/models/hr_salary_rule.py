...
class HrPayrollStructure(models.Model):
    ...
    def _get_parent(self):
        return self.env.ref('sh_hr_payroll.structure_base', False)
...
class HrSalaryRule(models.Model):
    ...
    child_count = fields.Integer(string='Children', compute='_compute_child_count')
    ...
    def _compute_child_count(self):
        for rec in self:
            rec.child_count = len(rec.child_ids or [])
